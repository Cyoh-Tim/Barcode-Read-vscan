...
// [빠른 불판독] 재촬영이 되는 배치용. 영역 구제의 **자르기는 남기고**
// 그 뒤 이미지 수술(대비/원근/곡면/반전)만 끈다 — 자르기가 회전을 담당해서,
// 통째로 끄면 회전된 1D를 잃는다(§3.78). 근거는 vscan.h의 fast_no_read 주석. 이미지 수술 단계를 끊고 빨리 "못 읽겠다"고
